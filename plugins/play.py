...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/e2f16132bb13483d93a0a.jpg"
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("𝐒𝐮𝐩𝐩𝐨𝐫𝐭", url="t.me/Social_Friends_Club"),
                    InlineKeyboardButton("𝐔𝐩𝐝𝐚𝐭𝐞𝐬", url="t.me/Superiour_x_Server"),
                ],
        ...
        try:
            ...
            title = "NaN"
            thumb_name = "https://telegra.ph/file/c3d17256649ddb37397e6.jpg"
            duration = "NaN"
            views = "NaN"
            keyboard = InlineKeyboardMarkup(
        ...
        if len(message.command) < 2:
            return await lel.edit(
                "🧐 **Song not found! Try searching with the correct **"
            )
